        ...
        <div class="sidebar-wrapper scrollbar-inner">
            <div class="sidebar-content">
                ...
                <ul class="nav">
                            ...
                            <ul class="nav nav-collapse">
                                <li>
                                    <a href="components/avatars.html">
                                        <span class="sub-item">Pesan Masal</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="components/buttons.html">
                                        <span class="sub-item">Pesan Terjadwal</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="components/gridsystem.html">
                                        <span class="sub-item">Pesan Template</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <li class="nav-item">
                        <a data-toggle="collapse" href="#pengaturanumum">
                            <i class="fab fa-whatsapp"></i>
                            <p>Whatshapp</p>
                            <span class="caret"></span>
                        </a>
                        <div class="collapse" id="pengaturanumum">
                            <ul class="nav nav-collapse">
                                <li>
                                    <a href="components/avatars.html">
                                        <span class="sub-item">Pesan Masal</span>
