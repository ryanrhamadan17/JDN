			  ...
			  <div class="card-body">
				<div class="form-group">
				  <div class="input-group mb-3">
					...
					<input type="text" class="form-control" name="nama" aria-label="nama" value="{{$data->nama}}" aria-describedby="basic-addon1">
				  </div>
				</div>
				<div class="form-group">
				  <div class="input-group-prepend">
				...
				<div class="form-row">
				  <div class="form-group ">
					...
					<input type="text" class="form-control" name="lat" value="{{$data->lat}}" id="latitude" placeholder="latitude">
				  </div>
				  <div class="form-group ">
					<label for="inputPassword4">longitude</label>
					<input type="text" class="form-control" name="long" value="{{$data->long}}" id="longitude" placeholder="longitude">
				  </div>
				</div>
				<div class="form-group">
				  <div class="input-group">
					<textarea class="form-control" aria-label="With textarea" value="$data->desc" name="desc" id="my-editor"></textarea>
				  </div>
				</div>
			  </div>
